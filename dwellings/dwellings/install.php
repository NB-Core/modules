<?php
	...
	$dwellings = array(
		...
		'name'=>array('name'=>'name', 'type'=>'varchar(255)', 'default'=>'',  'extra'=>'not null'),
		'description'=>array('name'=>'description', 'type'=>'text'),
		'location'=>array('name'=>'location', 'type'=>'varchar(255)', 'default'=>'','extra'=>'not null'),
		'windowpeer'=>array('name'=>'windowpeer', 'type'=>'text'),
		'gold'=>array('name'=>'gold', 'type'=>'int unsigned','default'=>0),
		'gems'=>array('name'=>'gems', 'type'=>'int unsigned','default'=>0),
		'status'=>array('name'=>'status', 'type'=>'tinyint','default'=>0, 'extra'=>'not null'),
		'type'=>array('name'=>'type', 'type'=>'varchar(50)', 'default'=>'', 'extra'=>'not null'),
		'goldvalue'=>array('name'=>'goldvalue','default'=>0, 'type'=>'int unsigned'),
		'gemvalue'=>array('name'=>'gemvalue','default'=>0, 'type'=>'int unsigned'),
		'storedinfo'=>array('name'=>'storedinfo', 'type'=>'mediumtext'),
...
//if I find the baboon who thought placing the dwelling owner id on each line of the key they give out, I'll rain down hellfire.
//honestly, this produces funny things when the previous owner of the dwelling gets a key......... and so on.
