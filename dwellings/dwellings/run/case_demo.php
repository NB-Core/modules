<?php
	...
	if (!$submit){
		...
		output("If you are going to demolish your dwelling now, you shall receive `^%s `#gold and `%%s `#gems.",$gold,$gems);
		...
		debuglog("received $gold gold and $gems gems for demolishing their dwelling.");
