    ...
    $info = array(
        ...
        "settings"=>array(
			...
			"Coffer Settings,title",
                ...
                "maxgold"=>"What is the max storage of gold? - 0 to disable - 12345 for unlimited,int|50000",
                "maxgems"=>"What is the max storage of gems? - 0 to disable - 12345 for unlimited,int|25",
