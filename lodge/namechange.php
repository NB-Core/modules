...
function namechange_run(){
	...
	switch ($op) {
		case "namechange":
			...
			output("Note that special characters (Kanji i.e.) count up to a length of 4 normal characters. You will have to check the preview if your name is shown correctly.`n`n");
		...
		case "namepreview":
			...
			$ntitle=namechange_remove_emoji($ntitle);
...
function namechange_remove_emoji($text){
